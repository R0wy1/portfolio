...
--
-- Hôte : localhost
-- Généré le : lun. 17 nov. 2025 à 15:21
...
--
-- Base de données : `paris sportifs`
--
...
(1, 'PSG', 'OM', '2025-11-18', 1),
(2, 'Lakers', 'Bulls', '2025-11-19', 2),
(3, 'Nadal', 'Ferderer', '2025-11-20', 3);
...
INSERT INTO `utilisateurs` (`id_user`, `nom`, `prenom`, `email`) VALUES
(1, 'Dupont', 'Marc', 'dupontmarc@gmail.com'),
(2, 'Lopez ', 'Sara', 'lopezsara2@gmail.com'),
(3, 'Idrissi ', 'Karim', 'karimidr@gmail.com');
...
--
ALTER TABLE `typepari`
  MODIFY `id_typepari` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `pari`
  ADD CONSTRAINT `pari_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `utilisateurs` (`id_user`),
  ...
  ADD CONSTRAINT `pari_ibfk_4` FOREIGN KEY (`id_pari`) REFERENCES `gain` (`id_pari`);
COMMIT;
